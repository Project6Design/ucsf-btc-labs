...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      vector: {
        files: ['images/source/optimized/*.svg'],
    ...
    svgstore: {
      ...
      default: {
        files: {
          'images/optimized/store.svg': ['images/optimized/*.svg', '!images/optimized/store.svg']
        },
      }
    },
    sass: {
  ...
  grunt.registerTask('default', ['babel', 'uglify', 'sass', 'postcss']);
};
